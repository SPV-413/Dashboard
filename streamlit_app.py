...
def generate_dashboard(df):
    ...
    if df_filtered.empty:
        st.warning("No data remains after applying filters. Adjust your filter selections.")
        return
    ...
    if uploaded_file:
        ...
        if df is not None:
            ...
            if not df.empty and (numeric_cols or categorical_cols or datetime_cols or geo_cols):
                ...
                st.warning("No usable data or columns remaining after cleaning. Please adjust your selections.")
        else:
